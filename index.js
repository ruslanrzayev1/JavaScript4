...
//   console.log(results.find((item) => item.id === id).shipAddress.country);
// }
...
// function findCountry(id) {
// console.log(results.find((item) => item.id === id).shipName);
// console.log(results.find((item) => item.id === id).shipAddress.country);
// console.log(results.find((item) => item.id === id).shipAddress.city);
// }
// findCountry(10271);

// "4.ID-ə görə neçə növdə satış edildiyini göstərən function yazın. (details sayı)"

// function findObyekt(id) {
//   console.log(results.find((item) => item.id == id).details.length);
// }
// findObyekt(10254)
...
// function search(id){
//         let object = results.find(item => item.id == id);
//         let firstElement = 0
